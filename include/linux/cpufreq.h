...
#elif defined(CONFIG_CPU_FREQ_GOV_SKYWALKER)	
extern struct cpufreq_governor cpufreq_skywalker;	
#define CPUFREQ_DEFAULT_GOVERNOR  (&cpufreq_skywalker)	
#elif defined(CONFIG_CPU_FREQ_GOV_LULZACTIVE)	
extern struct cpufreq_governor cpufreq_lulzactive;	
#define CPUFREQ_DEFAULT_GOVERNOR  (&cpufreq_lulzactive)	
#endif
