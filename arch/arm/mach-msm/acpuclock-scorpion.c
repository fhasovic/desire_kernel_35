...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 806400, CCTL(CLK_TCXO, 1),		SRC_SCPLL, 0x15, 0, 1250, 128000 },
	{ 844800, CCTL(CLK_TCXO, 1),		SRC_SCPLL, 0x16, 0, 1275, 128000 },
	...
	{  96000, CCTL(CLK_TCXO, 1),		SRC_AXI, 0, 0, 1050, 14000 },
	{ 128000, CCTL(CLK_TCXO, 1),		SRC_RAW, 0, 0, 1050, 14000 },
	...
	{ 1152000, CCTL(CLK_TCXO, 1), 		SRC_SCPLL, 0x1D, 0, 1325, 128000 },
	{ 1190400, CCTL(CLK_TCXO, 1),		SRC_SCPLL, 0x1E, 0, 1325, 128000 },
#endif
#endif
